...
const names = ['John', 'Sandy'];
 ...
 // even if const values are immutable, it does not mean it cannot be totally modified. 
 // You can use push, pop, shift and unshift to modify the value only if it is an array
names.pop('Sandy');

 // Error will occur here since you cannot re-assign values to const variables.
 // (Uncaught TypeError: Assignment to constant variable.)
names = ['Eric', 'Marvin']; // Delete this line if you want the code to work
